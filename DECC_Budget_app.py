...
if st.button("Get Insights"):
    if user_input.strip():
        ...
        st.markdown(""" It looks like you’re in great financial shape for the move back to Texas! With **$25,580** in savings, you’ve got a solid cushion, though it’s a good idea to pay down **$1,020** on your credit cards to free up flexibility. 
